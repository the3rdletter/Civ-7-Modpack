...
(function (HighlightColors) {
    ...
    // Numbers in abgr
    HighlightColors[HighlightColors["unique"] = 3372155012] = "unique";
...
class PlaceBuildingInterfaceMode extends ChoosePlotInterfaceMode {
    ...
    decorate(overlay) {
        ...
        this.plotOverlay.addPlots(BuildingPlacementManager.expandablePlots, { fillColor: HighlightColors.good }); // good
    ...
    proposePlot(plot, accept, reject) {
        ...
        if (BuildingPlacementManager.urbanPlots.find(p => p == plotIndex)
            || BuildingPlacementManager.expandablePlots.find(p => p == plotIndex)
            || BuildingPlacementManager.uniquePlots.find(p => p == plotIndex)) {
            accept();
