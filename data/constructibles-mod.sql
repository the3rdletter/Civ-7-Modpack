...
UPDATE Buildings SET Town=1 WHERE ConstructibleType='BUILDING_MODERN_BRIDGE';
--------------------------------------------------------------

-- Constructibles
--------------------------------------------------------------
UPDATE Constructibles SET Age=NULL, RequiresUnlock=1	WHERE ConstructibleType='BUILDING_ANCIENT_BRIDGE';
UPDATE Constructibles SET Age=NULL, RequiresUnlock=1	WHERE ConstructibleType='BUILDING_MEDIEVAL_BRIDGE';
UPDATE Constructibles SET Age=NULL						WHERE ConstructibleType='BUILDING_MODERN_BRIDGE';

UPDATE Constructibles SET Cost=(SELECT Cost FROM Constructibles WHERE ConstructibleType='BUILDING_MODERN_BRIDGE') WHERE ConstructibleType='BUILDING_ANCIENT_BRIDGE';
UPDATE Constructibles SET Cost=(SELECT Cost FROM Constructibles WHERE ConstructibleType='BUILDING_MODERN_BRIDGE') WHERE ConstructibleType='BUILDING_MEDIEVAL_BRIDGE';
--------------------------------------------------------------

-- Constructible_YieldChanges
--------------------------------------------------------------
DELETE FROM Constructible_YieldChanges WHERE ConstructibleType='BUILDING_ANCIENT_BRIDGE';
DELETE FROM Constructible_YieldChanges WHERE ConstructibleType='BUILDING_MEDIEVAL_BRIDGE';
--------------------------------------------------------------
...
VALUES	('BUILDING_MODERN_BRIDGE',	'QuarterGold');
--------------------------------------------------------------
...
--		('IGNORE_DISTRICT_PLACEMENT_CAP',	'BUILDING_MEDIEVAL_BRIDGE'),
		...
		('WATER',							'BUILDING_MEDIEVAL_BRIDGE'),
		('BRIDGE',							'BUILDING_MEDIEVAL_BRIDGE'),
--		('IGNORE_DISTRICT_PLACEMENT_CAP',	'BUILDING_MODERN_BRIDGE'),
		('AGELESS',							'BUILDING_MODERN_BRIDGE'),
		('PERSISTENT',						'BUILDING_MODERN_BRIDGE');

-- DELETE FROM TypeTags WHERE Tag='GOLD' AND Type='BUILDING_MODERN_BRIDGE';
--------------------------------------------------------------
...
WHERE	TargetType='BUILDING_MODERN_BRIDGE';
...
VALUES	('MOD_JNR_MO_MEDIEVAL_BRIDGE_UNLOCK',	'MODIFIER_JNR_ALL_PLAYERS_GRANT_CONSTRUCTIBLE_UNLOCK',	'REQSET_JNR_BRIDGE_UPGRADE',	0,			0),
		('MOD_JNR_MO_MEDIEVAL_BRIDGE_REPLACE',	'MODIFIER_JNR_SINGLE_PLAYER_REPLACE_CONSTRUCTIBLE',		NULL,							1,			1);
--------------------------------------------------------------
...
VALUES	('MOD_JNR_MO_MEDIEVAL_BRIDGE_UNLOCK',	'ConstructibleType',	'BUILDING_MEDIEVAL_BRIDGE'),
		('MOD_JNR_MO_MEDIEVAL_BRIDGE_REPLACE',	'Destroy',				'BUILDING_MEDIEVAL_BRIDGE'),
		('MOD_JNR_MO_MEDIEVAL_BRIDGE_REPLACE',	'Create',				'BUILDING_MODERN_BRIDGE');
--------------------------------------------------------------
...
VALUES	('MOD_JNR_MO_MEDIEVAL_BRIDGE_REPLACE',	'Description',	'LOC_MOD_JNR_MO_MEDIEVAL_BRIDGE_REPLACE_DESCRIPTION');
--------------------------------------------------------------
...
INSERT OR IGNORE INTO GameModifiers
		(ModifierId)
VALUES	('MOD_JNR_MO_MEDIEVAL_BRIDGE_UNLOCK');
--------------------------------------------------------------
...
SELECT	ProgressionTreeNodeType,	'MOD_JNR_MO_MEDIEVAL_BRIDGE_REPLACE',	'KIND_MODIFIER',	UnlockDepth
FROM	ProgressionTreeNodeUnlocks
WHERE	TargetType='BUILDING_MODERN_BRIDGE';
--------------------------------------------------------------		