...
UPDATE PlotEvalConditions SET GoodValue = -6, PoorValue = -8 WHERE ConditionType = 'Nearest Friendly City';
...
UPDATE PlotEvalConditions SET GoodValue = 25, PoorValue = 15 WHERE ConditionType = 'Total Yield';
