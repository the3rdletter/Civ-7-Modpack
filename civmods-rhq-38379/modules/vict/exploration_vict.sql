...
------------------------------------------------
-- DLC. May need to be moved to work without DLC

-- Def Normans 2

UPDATE LeaderCivPriorities -- Def 1
SET Priority = 4
WHERE Leader = 'LEADER_ADA_LOVELACE' 
AND Civilization = 'CIVILIZATION_ABBASID';

INSERT OR IGNORE INTO LeaderCivPriorities (Leader, Civilization, Priority)  
VALUES ('LEADER_ADA_LOVELACE', 'CIVILIZATION_HAWAII', 3); 
