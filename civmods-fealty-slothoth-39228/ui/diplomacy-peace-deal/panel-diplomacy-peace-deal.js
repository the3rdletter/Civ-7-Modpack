...
class DiplomacyPeaceDealPanel extends DiplomacyInputPanel {
    ...
    onAttach() {
        ...
        const localPlayerReceivesTitleWrapper = MustGetElement(".peace-deal__local-player-receives-title-wrapper", document);
        const localPlayerReceivesIconWrapper = MustGetElement(".peace-deal__local-player-receives-icon-wrapper", document);
    ...
    populatePeaceDeal() {
        ...
        const otherPlayerReceivesIconWrapper = MustGetElement(".peace-deal__other-player-receives-icon-wrapper", document);
        ...
        const otherPlayerReceivesTitleWrapper = MustGetElement(".peace-deal__other-player-receives-title-wrapper", document);
        ...
        const acceptRejectWrapper = MustGetElement(".panel-diplomacy-peace-deal__inspect-wrapper", document);
