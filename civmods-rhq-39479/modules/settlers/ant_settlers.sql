...
-- 13 / 5 worked well, want to incrase possible locations when all are taken
UPDATE PlotEvalConditions SET GoodValue = 13, PoorValue = -50 WHERE ConditionType = 'Inner Ring Yield';
-- Default GoodValue is 50 and PoorValue is 30
UPDATE PlotEvalConditions SET GoodValue = 25, PoorValue = -25 WHERE ConditionType = 'Total Yield';
