...
INSERT OR IGNORE INTO PseudoYields (PseudoYieldType, DefaultValue) VALUES 
       ('PSEUDOYIELD_NEW_CITY', 500000), -- Default 400
...
-- ==========================================================================
-- Double the value of all construction biases -- Helps with uniques
-- If this setting is too high, civs won't build settlers.
UPDATE AiFavoredItems
SET Value = Value * 1
